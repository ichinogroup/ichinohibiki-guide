...
const data = {
  en: {
    ...
    items: [
      ...
      ["Trash Disposal", "Please separate domestic waste and cans/bottles into labeled bins.<br>If the bin is full, remove the garbage from the bin, place it outside the front door, and contact the staff for collection.<br><br><img src='assets/images/garbage.png' style='width:100%; max-width:320px; border-radius:10px;'><br><br><img src='assets/images/garbage2.png' style='width:100%; max-width:320px; border-radius:10px;'>"],
...
`<div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; line-height: 1.6;">
  ...
  jp: {
    ...
    items: [
      ...
      ["ゴミ捨て方", "燃えるゴミ、缶・瓶類は指定のラベル付きゴミ箱に分別してください。ゴミ箱がいっぱいになった場合は、ゴミを取り出して玄関の外に置き、回収スタッフに連絡してください。<br><br><img src='assets/images/garbage.png' style='width:100%; max-width:320px; border-radius:10px;'><br><br><img src='assets/images/garbage2.png' style='width:100%; max-width:320px; border-radius:10px;'>"],
...
`<div style="font-family: Arial, sans-serif; max-width: 850px; margin: 0 auto; line-height: 1.7;">
  ...
  cn: {
    ...
    items: [
      ...
      ["如何丢垃圾", "请将可燃垃圾、罐子/瓶子分类放入有标签的垃圾桶。如果垃圾桶满了，请将垃圾取出，放在房子前门外面，并联系工作人员前来收取。<br><br><img src='assets/images/garbage.png' style='width:100%; max-width:320px; border-radius:10px;'><br><br><img src='assets/images/garbage2.png' style='width:100%; max-width:320px; border-radius:10px;'>"],
